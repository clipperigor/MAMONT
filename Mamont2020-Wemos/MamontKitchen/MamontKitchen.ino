...
const char* hn = "Mamont.Kitchen"; //имя хоста платы -Кухня
...
String makeJsonBody(){
  ...
  for (int i=0; i<4; i++){
   ...
   String url = "{\"hostname\":\"Кухня\",\"values\":[";
    sensors.requestTemperatures();
    
    url+="{\"title\":\"Температура На кухне под раковиной\",\"value\":\""+String(sensors.getTempCByIndex(0))+"\",\"cmd\": \"T1\"}";
